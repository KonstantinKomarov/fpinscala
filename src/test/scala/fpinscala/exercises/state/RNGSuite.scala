...
class RNGSuite extends PropSuite:
  ...
  test("RNG.ints")(genRNG ** genCounter ** genLengthOfList):
  ...
  test("RNG.map2ViaFlatMap")(genRNG ** genCounter):
    case rng ** counter =>
